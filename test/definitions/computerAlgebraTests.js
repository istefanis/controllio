...
export const computerAlgebraTests = {
  test1: {
    description: "test1: add(1, 1.5)",
    assertion: [add(1, 1.5), 2.5],
  },

  test2: {
    description: "test2: add(new Ratio(3, 5), new Ratio(2, 5))",
    assertion: [add(new Ratio(3, 5), new Ratio(2, 5)), ["ratio", [25, 25]]],
  },

  test3: {
    description: "test3: subtract(new Ratio(3, 5), new Ratio(3, 5))",
    assertion: [subtract(new Ratio(3, 5), new Ratio(3, 5)), ["ratio", [0, 25]]],
  },

  test4: {
    description: "test4: new Ratio(p2, p1)",
    assertion: [
      new Ratio(p2, p1),
      [
        "ratio",
  ...
  test5: {
    description: "test5: add(p1, p2)",
    assertion: [add(p1, p2), ["polynomial", ["x", [1, -1, 0]]]],
  },

  test6: {
    description: "test6: subtract(p1, p2)",
    assertion: [subtract(p1, p2), ["polynomial", ["x", [1, -3, 2]]]],
  },

  test7: {
    description: "test7: multiply(p1, p2)",
    assertion: [multiply(p1, p2), ["polynomial", ["x", [1, -3, 3, -1]]]],
  },

  test8: {
    description: "test8: subtract(p2, new Polynomial('x', [1]))",
    assertion: [
  ...
  test9: {
    description: "test9: divide(p1, p2)",
    assertion: [divide(p1, p2), [["x", [1, -1]]]],
  },

  test10: {
    description: "test10: simplify(new Ratio(p1, p2))",
    assertion: [
  ...
  test11: {
    description: "test11: simplify(new Ratio(p3, new Polynomial('x', [2])))",
    assertion: [
